...
_C.VERSION = 'v1.0.3'
# _C.DESCRIPTION = "MonoSmoke Default Configuration"

# _C.OUTPUT_DIR = "logs/gupnet_debug"                               # Output Directory
...
# Data
_C.DATA = CN()
_C.DATA.ROOT = r'/mnt/goosefs/bjcar01/algorithm/public_data/det3d/kitti/'                  # KITTI Root
...
_C.SOLVER.SCHEDULER.TARGET_LR_RATIO = (10, 1E-04)
